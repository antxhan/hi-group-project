import member1Image from './Anita.jpeg';
import emailImage from './email.png';
import webImage from './web.png';
import antonImage from './Anton Hansson.png';
import ChiranjeeviImage from './Chiranjeevi Vattiri.png';
import dylanImage from './Dylan St. John.png';
...
export default function About() {
  ...
  intro2.innerText = 'Energetic Person - Willing to explore new challenges in life.'
  ...
  intro3.innerText = 'Passionate person specialized in creating dynamic, user-friendly interface.'
  ...
  intro4.innerText = 'Professional developer during the day, amateur Tetris player at night.'
